...
local windows = mod:io_dofile("Death Sound/scripts/mods/Death Sound/simpleaudio/platform/windows")

local native = {}

local RUNTIME_PATH = "../mods/Death Sound/bin/simple-audio-runtime.dll"
