...
local playback_options = mod:io_dofile("Death Sound/scripts/mods/Death Sound/simpleaudio/playback/options")
local spatial = mod:io_dofile("Death Sound/scripts/mods/Death Sound/simpleaudio/playback/spatial")
